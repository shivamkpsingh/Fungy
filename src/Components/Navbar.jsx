...
const Navbar = () => {
  return (
    <>
      <div className="py-4 border-b px-16 border-black">
        <div className="flex items-center">
          <div className="logo flex items-center">
            <PollIcon className="poll__Icon  text-blue-500 transform rotate-45" />
            <h1 className="font-extrabold text-4xl ml-3">Fungy</h1>
          </div>
          <div className="search ml-6">
          ...
          <div className="menu flex ml-6 text-lg text-gray-500 font-medium">
            <a href="/">Explore</a>
          ...
          <div className=" ml-6 flex items-center">
            ...
            <div className=" drop-down">
              <div className="token border flex items-center ml-5 rounded-full px-4 py-1 hover:text-blue-600 cursor-pointer hover:border-blue-600 ">
                <h1 className="text-lg">0</h1>
                <h1 className="text-lg ml-2">TOKEN</h1>
              </div>
